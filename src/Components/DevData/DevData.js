...
export const reportTypesbox = [
  { id: 1, icon: <CiWallet size={20} />, label: "المبيعات" },
  { id: 2, icon: <CiWallet size={20} />, label: "المنتجات" },
  { id: 3, icon: <CiWallet size={20} />, label: "الزيارات" },
  { id: 4, icon: <CiWallet size={20} />, label: "الاكثر طلبا" },
  { id: 5, icon: <CiWallet size={20} />, label: "المبيعات" },
  { id: 6, icon: <CiWallet size={20} />, label: "المنتجات" },
];
...
export const QaData = [
  {
    ...
    statusButtons: [
      { icon: <FaCheck />, label: "منشور" },
      { icon: <RxCross2 />, label: "غير منشور" },
      { icon: <IoArrowRedo />, label: "الرد" },
    ],
  },
  {
    id: 2,
