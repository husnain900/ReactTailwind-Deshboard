                  ...
                  <div className="tech-prooptionspopup-box-content">
                    ...
                    <div className="tech-productoption-row">
                      <div className="tech-productoption-col-1">
                        ...
                        <small>
                          أدخل الوزن الفعلي للمنتج ليتم معالجته بشكل صحيح من قبل
                          شركة الشحن، وفي حال كانت منتجاتك ذات حجم كبير الرجاء
                          الانتباه للوزن الحجمي
                        ...
                        <div className="tech-productoption-input-group weight-field">
                          ...
                          <input type="text" name="" placeholder="وزن المنتج" />
                          <select>
                            <option>كجم</option>
                            <option>جم</option>
                            <option>أوقية</option>
                    ...
                    <div className="tech-productoption-row">
                      <div className="tech-productoption-col-1 readonly-main">
                        ...
                        <p className="mt-2">
                          <span className="">
                            العنوان الفرعي يظهر تحت اسم المنتج في المتجر، بحد
                            اقصى 35 حرف. نسبة الخصم:
                    ...
                    <div className="tech-productoption-row">
                      <div className="tech-productoption-col-1 readonly-main">
                        ...
                        <p className="mt-2">
                          <span className="">
                            العنوان الترويجي يظهر على صورة المنتج في المتجر، بحد
                            أقصى 25 حرف. نسبة الخصم:
                            <button>{percent}</button>
                          </span>
                          <span>
                            مبلغ الخصم:
